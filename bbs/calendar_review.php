...
function date_send(year, month, day, wday, handay)
{
	...
	if ('<?=$fld?>'=='review_a_date'){
		//alert("ReviewerA");
		opener.change_review_dateA(opener.document.getElementById('<?=$fld?>').value);
	}else if ('<?=$fld?>'=='review_b_date'){
		//alert("ReviewerB");
		opener.change_review_dateB(opener.document.getElementById('<?=$fld?>').value);
	}else if ('<?=$fld?>'=='review_c_date'){
		//alert("ReviewerC");
		opener.change_review_dateC(opener.document.getElementById('<?=$fld?>').value);
	}else if ('<?=$fld?>'=='review_d_date'){
		//alert("ReviewerD");
		opener.change_review_dateD(opener.document.getElementById('<?=$fld?>').value);
	}else if ('<?=$fld?>'=='review_e_date'){
		//alert("ReviewerE");
		opener.change_review_dateE(opener.document.getElementById('<?=$fld?>').value);
	}
