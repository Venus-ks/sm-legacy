...
$mb_id = trim(strip_tags(mysqli_escape_string($_POST[mb_id])));
$mb_password = trim(mysqli_escape_string($_POST[mb_password]));
$mb_name = trim(strip_tags(mysqli_escape_string($_POST[mb_name])));
$mb_nick = trim(strip_tags(mysqli_escape_string($_POST[mb_nick])));
$mb_email = trim(strip_tags(mysqli_escape_string($_POST[mb_email])));
$mb_homepage = trim(strip_tags(mysqli_escape_string($_POST[mb_homepage])));
