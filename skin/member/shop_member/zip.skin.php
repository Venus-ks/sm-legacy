...
<style type="text/css">
.m_title    { BACKGROUND-COLOR: #EFEFEF; padding: 8px 0 8px 0; border-bottom: 1px solid #B6B6B6; }
.m_padding  { BACKGROUND-COLOR: #FFF; text-align: left; padding: 8px 0 8px 15px; border-bottom: 1px solid #B6B6B6; }
...
<div style="font: normal 12px '돋움'; padding: 10px 20px">
...
<tr>
    <td align="center">
        <table width="566" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #B6B6B6;">
        <tr>
            <td>
                <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="m_title"><label for="sido">시도선택</label></td>
                    <td class="m_padding">
                        <select name="sido" id="sido">
                            <option value="">- 시도 선택 -</option>
                        </select>
                    </td>
                    <td class="m_title"><label for="gugun">시군구</label></td>
                    <td class="m_padding">
                ...
                <tr>
                    <td class="m_title"><label for="q">검색어</label></td>
