...
<tr>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="font_16"><img src="../images/icon.png"  align="absmiddle" class="mr5" />���� ����</td>
		</tr>
		</table>
	...
	<tr>
		<td class="font_16"><img src="../images/icon.png"  align="absmiddle" class="mr5" />�ɻ��ǰ߼�</td>
	</tr>
	</table>
<?
...
?>
		...
		<tr>
			<th width="150"><strong>�ɻ��ǰ߼�</strong></th>
			<td>
				<? if($review1['rfile']){ ?> 
