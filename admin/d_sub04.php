...
###
$where		= " ( step = 5 or step = 15 or step = 25 ) ";
...
###
$write_pages = get_paging(10, $page, $total_page, "./d_sub04.php?page=");
?>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<td><a href="./d_sub04_write.php?seq=<?=$list[$i]['seq']?>"><img src="../images/btn_paper_reviewer3.png"  /></a></td>
			</tr>
			<?
				}
					}else{
