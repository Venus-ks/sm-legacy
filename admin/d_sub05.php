...
<tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td background="../images/titlebg.png"><img src="../images/03_title05.png" /></td>
	</tr>
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<td><a href="./d_sub05_write.php?seq=<?=$list[$i]['seq']?>"><img src="../images/btn_paper_reviewer4.png"  /></a></td>
			</tr>
			<?
					}
				}else{
